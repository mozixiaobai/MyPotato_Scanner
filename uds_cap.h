...
//去除杂点 数目
#define UDSCAP_REMOVENOISENUMFB              CAP_CUSTOMBASE+72
#define UDSCAP_REMOVENOISENUMBB              CAP_CUSTOMBASE+73
//去除斑点 范围
#define UDSCAP_REMOVENOISERANGEFB            CAP_CUSTOMBASE+74
#define UDSCAP_REMOVENOISERANGEBB            CAP_CUSTOMBASE+75

#define UDSCAP_EDGE_COLOR                    CAP_CUSTOMBASE+76  /**< 边缘扩充颜色 */

#define UDSCAP_NOCOLOR                       CAP_CUSTOMBASE+77  /**< 非彩色时扫描 */
#define UDSCAP_COLORTHRESHOLD                CAP_CUSTOMBASE+78  /**< 色彩阈值 */

#define UDSCAP_COMPRESSQUALITY               CAP_CUSTOMBASE+79  /**< 压缩质量 */                   

//多流压缩质量  UDSCAP_COMPRESSQUALITY
#define UDSCAP_COMPRESSQUALITYFC             CAP_CUSTOMBASE+80
#define UDSCAP_COMPRESSQUALITYFG             CAP_CUSTOMBASE+81
#define UDSCAP_COMPRESSQUALITYFB             CAP_CUSTOMBASE+82
#define UDSCAP_COMPRESSQUALITYBC             CAP_CUSTOMBASE+83
#define UDSCAP_COMPRESSQUALITYBG             CAP_CUSTOMBASE+84
#define UDSCAP_COMPRESSQUALITYBB             CAP_CUSTOMBASE+85 

//新界面增加参数
//（图像处理部分）
#define UDSCAP_ROTATEMODE                    CAP_CUSTOMBASE+86 /**< 图像旋转--模式 */
#define UDSCAP_BACKIMGROTATE                 CAP_CUSTOMBASE+87 /**< 图像旋转--背面图像旋转 */

#define UDSCAP_JOINIMAGE                     CAP_CUSTOMBASE+88 /**< 图像拼接 */

#define UDSCAP_BACKPROCESS                   CAP_CUSTOMBASE+89 /**< 背景处理 */
#define UDSCAP_BACKPROSTRENTH                CAP_CUSTOMBASE+90 /**< 背景处理强度 */
#define UDSCAP_BACKPROMODE                   CAP_CUSTOMBASE+91 /**< 背景处理模式 */
#define UDSCAP_BACKPROFILLCOLOR              CAP_CUSTOMBASE+92 /**< 背景处理填补颜色 */

#define UDSCAP_COLORCORRECT                  CAP_CUSTOMBASE+93  /**<  色彩校正 */ 
#define UDSCAP_COLORCORRECTFC                CAP_CUSTOMBASE+94  /**<  多流色彩优化*/
#define UDSCAP_COLORCORRECTBC                CAP_CUSTOMBASE+95  /**<  多流色彩优化*/

#define UDSCAP_NATIVESAVE                    CAP_CUSTOMBASE+96  /**<  本地保存*/

#define UDSCAP_EDGE_ORIENTATION              CAP_CUSTOMBASE+97 /**<  边缘扩充方向*/
#define UDSCAP_EDGE_CORNERCOLOR              CAP_CUSTOMBASE+98 /**<  边缘扩充--未扫描部分边角填充颜色*/

#define UDSCAP_OVERLENGTH                    CAP_CUSTOMBASE+99  /**<  超出预定长度检测*/
#define UDSCAP_OVERLENGTHVALUE               CAP_CUSTOMBASE+100  /**<  超出预定长度检测值*/

#define UDSCAP_SEPARATEPAGE                  CAP_CUSTOMBASE+101  /**<  分隔页*/

#define UDSCAP_CODEIDENTITY                  CAP_CUSTOMBASE+102  /**<  一二维码识别*/
#define UDSCAP_CODESTANDARD                  CAP_CUSTOMBASE+103  /**<  条码格式*/

#define UDSCAP_PREFEED                       CAP_CUSTOMBASE+104  /**<  预先进纸*/
#define UDSCAP_PREFEEDTIME                   CAP_CUSTOMBASE+105  /**<  预先进纸值*/

#define UDSCAP_WAITTIME                      CAP_CUSTOMBASE+106 /**<  连续扫描等待放纸时间*/

#define UDSCAP_EMERGENCY                     CAP_CUSTOMBASE+107 /**<  紧急按钮*/

//多流滤除颜色  UDSCAP_FILTERCOLOR
#define UDSCAP_FILTERCOLORFG                 CAP_CUSTOMBASE+108
#define UDSCAP_FILTERCOLORFB                 CAP_CUSTOMBASE+109
#define UDSCAP_FILTERCOLORBG                 CAP_CUSTOMBASE+110
#define UDSCAP_FILTERCOLORBB                 CAP_CUSTOMBASE+111
//多流滤除模式
#define UDSCAP_FILTERMODEFG                  CAP_CUSTOMBASE+112
#define UDSCAP_FILTERMODEFB                  CAP_CUSTOMBASE+113
#define UDSCAP_FILTERMODEBG                  CAP_CUSTOMBASE+114
#define UDSCAP_FILTERMODEBB                  CAP_CUSTOMBASE+115
//多流滤除程度
#define UDSCAP_FILTERLEVELFG                 CAP_CUSTOMBASE+116
#define UDSCAP_FILTERLEVELFB                 CAP_CUSTOMBASE+117
#define UDSCAP_FILTERLEVELBG                 CAP_CUSTOMBASE+118
#define UDSCAP_FILTERLEVELBB                 CAP_CUSTOMBASE+119

//多流滤色高级选项
#define UDSCAP_FILTERCOLORADFG               CAP_CUSTOMBASE+120
#define UDSCAP_FILTERCOLORADFB               CAP_CUSTOMBASE+121
#define UDSCAP_FILTERCOLORADBG               CAP_CUSTOMBASE+122
#define UDSCAP_FILTERCOLORADBB               CAP_CUSTOMBASE+123
...
#define TWFF_BASE64                    50 // Base64格式 
#define TWFF_GIF                       51 // gif格式         
